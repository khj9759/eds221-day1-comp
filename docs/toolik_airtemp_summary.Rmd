...
```{r}
ggplot(data = toolik_weather, aes(x= month, y = daily_air_temp_mean_c)) + 
  geom_jitter(aes(color = daily_air_temp_mean_c)) + 
  scale_color_gradientn(colors = c("red","yellow","purple"))

# save the folder: figs, and the picture of this plot
